...
function setup() {
	...
	bob1 = Bodies.circle(400,380,20, {isStatic:true})
	World.add(world,bob1)
   
	bob2 = Bodies.circle(440,380,20, {isStatic:true})
	World.add(world,bob2)

	bob3 = Bodies.circle(480,380,20, {isStatic:true})
	World.add(world,bob3)

	bob4 = Bodies.circle(360,380,20, {isStatic:true})
	World.add(world,bob4)

	bob5 = Bodies.circle(320,380,20, {isStatic:true})
